...
(defun laooree-modeline--set-accent-normal   () (setq laooree-modeline-accent-color "#82b0ec"))
(defun laooree-modeline--set-accent-emacs    () (setq laooree-modeline-accent-color "#88ca9f"))
(defun laooree-modeline--set-accent-insert   () (setq laooree-modeline-accent-color "#caa6df"))
(defun laooree-modeline--set-accent-operator () (setq laooree-modeline-accent-color "#ff9580"))
(defun laooree-modeline--set-accent-replace  () (setq laooree-modeline-accent-color "#caa6df"))
(defun laooree-modeline--set-accent-visual   () (setq laooree-modeline-accent-color "#d2b580"))

(with-eval-after-load 'evil
  (add-hook 'evil-normal-state-entry-hook   #'laooree-modeline--set-accent-normal)
  (add-hook 'evil-emacs-state-entry-hook    #'laooree-modeline--set-accent-emacs)
  (add-hook 'evil-insert-state-entry-hook   #'laooree-modeline--set-accent-insert)
  (add-hook 'evil-operator-state-entry-hook #'laooree-modeline--set-accent-operator)
  (add-hook 'evil-replace-state-entry-hook  #'laooree-modeline--set-accent-replace)
  (add-hook 'evil-visual-state-entry-hook   #'laooree-modeline--set-accent-visual))
#+end_src
