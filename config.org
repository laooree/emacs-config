...
#+begin_src emacs-lisp :tangle "init.el"
  ...
  ;; Fonts
  (let ((mono-font-name "RecMonoLinear Nerd Font")
        (prop-font-name "Ubuntu Nerd Font")
        (font-size (cond
...
These custom functions are used to fetch infos to be displayed in mode-line as strings.
#+begin_src  emacs-lisp :tangle "init.el"
  (defun laooree/get-concise-evil-state nil
    "Returns a concise identifier for the active evil-state."
  ...
  (defun laooree/get-buffer-status-glyph nil
    "Returns a glyph representing the buffer status."
    (cond ((buffer-modified-p) "󰙏  ")
          ((eq buffer-read-only t) "  ")
          (t ""))
    )
#+end_src

Set mood-line as mode-line.
#+begin_src  emacs-lisp :tangle "init.el"
  (use-package mood-line
    ...
    (setq mood-line-format
          (mood-line-defformat
           ...
           (
            ;; Evil current mode
            ((laooree/get-concise-evil-state) . "")
            ;; Macro recording
