...
#+begin_src  emacs-lisp :tangle "init.el"
(defvar-local laooree-modeline-accent-color "#82b0ec"
...
(with-eval-after-load 'evil
    ...
    (defvar laooree-modeline--accent-color-emacs    (face-attribute 'mode-line-active :foreground)
      "Accent color to use when evil-state is emacs.")
    (defvar laooree-modeline--accent-color-insert   (face-attribute 'mode-line-active :foreground)
      "Accent color to use when evil-state is insert.")
    (defvar laooree-modeline--accent-color-operator (face-attribute 'mode-line-active :foreground)
      "Accent color to use when evil-state is operator.")
    (defvar laooree-modeline--accent-color-replace  (face-attribute 'mode-line-active :foreground)
      "Accent color to use when evil-state is replace.")
    (defvar laooree-modeline--accent-color-visual   (face-attribute 'mode-line-active :foreground)
...
(use-package haskell-mode
  ...
  (defun laooree-ghc-compile ()
    ...
    (interactive)
    (if buffer-file-name
        (shell-command (concat "ghc " (shell-quote-argument buffer-file-name)))
      (user-error "Buffer is not visiting a file")))
  ...
  (defun laooree-ghc-produce-assembly ()
    ...
    (interactive)
    (if buffer-file-name
        (shell-command (concat "ghc -S " (shell-quote-argument buffer-file-name)))
      (user-error "Buffer is not visiting a file")))
