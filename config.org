...
(use-package evil
  ...
  ;; Set mode-line accent color based on evil state
  (defun laooree-modeline--set-accent-normal ()
    (setq laooree-modeline-accent-color "#82b0ec"))
  (defun laooree-modeline--set-accent-emacs ()
    (setq laooree-modeline-accent-color "#88ca9f"))
  (defun laooree-modeline--set-accent-insert ()
    (setq laooree-modeline-accent-color "#caa6df"))
  (defun laooree-modeline--set-accent-operator ()
    (setq laooree-modeline-accent-color "#ff9580"))
  (defun laooree-modeline--set-accent-replace ()
    (setq laooree-modeline-accent-color "#caa6df"))
  (defun laooree-modeline--set-accent-visual ()
    (setq laooree-modeline-accent-color "#d2b580"))
  ...
  ;; Set mode-line accent color
  (evil-normal-state-entry   . laooree-modeline--set-accent-normal)
  (evil-emacs-state-entry    . laooree-modeline--set-accent-emacs)
  (evil-insert-state-entry   . laooree-modeline--set-accent-insert)
  (evil-operator-state-entry . laooree-modeline--set-accent-operator)
  (evil-replace-state-entry  . laooree-modeline--set-accent-replace)
  (evil-visual-state-entry   . laooree-modeline--set-accent-visual)
