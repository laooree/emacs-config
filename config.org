...
(defun laooree-modeline--scroll-indicator ()
  ...
  (propertize (concat (format "󰧮 %.0f" (/ (* 100.0 (point)) (point-max))) "%%") 'face '(:background "#4c566a" :foreground "#2e3440")))
#+end_src
*** Expressions
...
(defvar-local laooree-modeline-major-mode
    '(:eval (propertize (format " %s" (laooree-modeline--major-mode-name)) 'face '(:background "#4c566a" :foreground "#2e3440")))
