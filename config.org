...
#+begin_src emacs-lisp :tangle "init.el"
  (let ((mono-spaced-font "FiraMono Nerd Font")
        (proportionately-spaced-font "LibertinusSerif"))
    (set-face-attribute 'default nil :family mono-spaced-font :height 140)
    (set-face-attribute 'fixed-pitch nil :family mono-spaced-font :height 140)
    (set-face-attribute 'variable-pitch nil :family proportionately-spaced-font :height 170))
#+end_src
  ...
  (with-eval-after-load 'org
    (dolist (face '((org-level-1 . 1.3)
      ...
      (set-face-attribute (car face) nil
                          :family "LibertinusSans"  ;; Change to your preferred sans-serif font
                          :weight 'bold
                          :height (cdr face))))

  (custom-set-faces
   `(org-block ((t (:inherit fixed-pitch :height 140))))
   `(org-code ((t (:inherit fixed-pitch :height 140))))
   `(org-table ((t (:inherit fixed-pitch :height 140))))
   `(org-verbatim ((t (:inherit fixed-pitch :height 140))))
   `(org-meta-line ((t (:inherit fixed-pitch :height 140))))
   `(org-checkbox ((t (:inherit fixed-pitch :height 140))))
   )
#+end_src
