...
(use-package modus-themes
  ...
  ;; Function to run every time a theme is loaded
  (defun laooree-setup-theme (&rest _)
    ;; Set mode-line accent colors
    (setq laooree-modeline--accent-color-normal   "#82b0ec"
          laooree-modeline--accent-color-emacs    "#88ca9f"
          laooree-modeline--accent-color-insert   "#caa9df"
          laooree-modeline--accent-color-operator "#ff9580"
          laooree-modeline--accent-color-replace  "#caa9df"
          laooree-modeline--accent-color-visual   "#d2b580")

    ;; Color whitespace
    (with-eval-after-load 'whitespace
      (set-face-attribute 'whitespace-trailing nil :background (face-attribute 'font-lock-warning-face :foreground)))

    ;; Color org-source blocks
  ...
  :hook
  (modus-themes-after-load-theme . laooree-setup-theme)
