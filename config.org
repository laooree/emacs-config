...
(use-package nord-theme
  :ensure (:type git :host github :repo "laooree/nord-emacs")
  :demand t
...
(defun laooree-modeline--defining-kbd-macro ()
  ...
  (cond (defining-kbd-macro (concat (propertize "" 'face '(:background "#4c566a" :foreground "#88c0d0"))
                                    (propertize "  Rec" 'face '(:background "#88c0d0" :foreground "#4c566a"))
                                    (propertize " " 'face '(:background "#4c566a" :foreground "#88c0d0"))))
        (t "")))

(defun laooree-modeline--scroll-indicator ()
  "Indicate the scrolling percentage."
  (propertize (concat (format "󰧮 %.0f" (/ (* 100.0 (point)) (point-max))) "%%") 'face '(:foreground "#2e3440")))
#+end_src
*** Expressions
...
(defvar-local laooree-modeline-major-mode
    '(:eval (propertize (format " %s" (laooree-modeline--major-mode-name)) 'face '(:foreground "#2e3440")))
