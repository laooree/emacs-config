  ...
  (with-eval-after-load 'tree-sitter
    (let ((base00 (plist-get base16-stylix-theme-colors :base00))
      ...
      (custom-set-faces
       ...
       `(tree-sitter-hl-face:escape                ((t (:foreground ,base0D))))
       `(tree-sitter-hl-face:function              ((t (:foreground ,base07))))
       `(tree-sitter-hl-face:function.builtin      ((t (:foreground ,base07))))
       `(tree-sitter-hl-face:function.call         ((t (:foreground ,base07))))
       `(tree-sitter-hl-face:function.macro        ((t (:foreground ,base07))))
       `(tree-sitter-hl-face:function.special      ((t (:foreground ,base07))))
       `(tree-sitter-hl-face:keyword               ((t (:foreground ,base07))))
       ...
       `(tree-sitter-hl-face:operator              ((t (:foreground ,base07))))
       ...
       `(tree-sitter-hl-face:punctuation.bracket   ((t (:foreground ,base0E))))
       `(tree-sitter-hl-face:punctuation.delimiter ((t (:foreground ,base0E))))
