...
(use-package doric-themes
  ...
  (defun laooree-setup-theme (&rest _)
    ...
    ;; Improve comment and string faces
    (let ((string-color  (face-attribute 'font-lock-comment-face :foreground nil t))
          (comment-color (face-attribute 'font-lock-string-face  :foreground nil t)))
      (set-face-attribute 'font-lock-comment-face nil :foreground comment-color :slant 'normal)
      (set-face-attribute 'font-lock-comment-delimiter-face nil :foreground comment-color :slant 'normal)
      (set-face-attribute 'font-lock-string-face nil :foreground string-color))
