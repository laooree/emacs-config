...
(defun laooree-modeline--major-mode-name ()
  ...
  (replace-regexp-in-string "-" " " (replace-regexp-in-string "-ts" "" (replace-regexp-in-string "-mode\\'" "" (symbol-name major-mode))))
  )
...
(defun laooree-modeline--major-mode-with-icons ()
  ...
  (cond ((string= (laooree-modeline--major-mode-name) "org")     " Org Mode")
        ...
        ((string= (laooree-modeline--major-mode-name) "sh")      "#! sh")
