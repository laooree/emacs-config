...
(defun laooree-modeline--evil-state-indicator ()
  ...
  (laooree-modeline--with-indicator evil-mode-line-tag laooree-modeline-accent-color "#000000"))
...
;;   "Indicate the scrolling percentage."
;;   (let* ((value (format "%.0f" (/ (* 100.0 (point)) (point-max))))
;;          (percent (cond ((string= value "100") "Bot")
;;                         ((string= value "0")   "Top")
;;                         (t (concat value "%%")))))
;;     (laooree-modeline--with-indicator (concat " " percent " " (when (< (window-body-width) (window-total-width)) " ")) laooree-modeline-accent-color "#000000")))
...
Shows current/total lines, or percentage when `display-line-numbers-mode' is active."
  (let* ((indicator
    ...
    (laooree-modeline--with-indicator
     ...
     laooree-modeline-accent-color "#000000")))
